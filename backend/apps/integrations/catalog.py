...
PROVIDERS: list[dict] = [
    ...
    },
    {
        ...
        "setup_steps": [
            ...
            "Click Create a private app and name it Seonet.",
    ...
    },
    {
        ...
        "connectable": True,
        "required_module": "integrations",
        "description": "Any HTTPS REST API. Seonet POSTs leads and audit results with your API key. Secrets stay on the server.",
        "setup_steps": [
            ...
            "Seonet will POST new leads as JSON to /leads and finished audits to /results on that address. You can change those paths below if your API uses different ones.",
        ...
        "fields": _fields(
            ...
            {"key": "leads_path", "label": "Leads path", "secret": False, "required": False, "input": "text", "help": "Default /leads. Seonet POSTs JSON here."},
            {"key": "results_path", "label": "Results path", "secret": False, "required": False, "input": "text", "help": "Default /results. Seonet POSTs JSON here."},
    ...
    },
    {
        ...
        "connectable": True,
        "required_module": "integrations",
        "description": "Append leads and audit results as new rows in your spreadsheet. Uses a Google Cloud service account so Seonet can write without anyone staying signed in.",
        "setup_steps": [
            "In Google Drive, click New → Google Sheets. Name it something like Seonet leads.",
            ...
            "Click the project picker at the top → New project. Name it Seonet and click Create. Select that project if it is not already selected.",
            "Open the menu (three lines) → APIs & Services → Library. Search for Google Sheets API and click Enable.",
            "Open APIs & Services → Credentials → Create credentials → Service account. Name it seonet-sheets and click Done (you can skip optional steps).",
            ...
            "In the JSON, find client_email (it looks like seonet-sheets@….iam.gserviceaccount.com). Open your Google Sheet → Share, paste that email, choose Editor, uncheck Notify people, then Share.",
    ...
    },
    {
        ...
        "setup_steps": [
            ...
            "Save. Copy the signing secret immediately — it is shown only once. Your developer checks the X-Seonet-Signature header.",
    ...
    },
    {
        ...
        "setup_steps": [
            ...
            "Create an app named Seonet. Open API credentials and install the app on the shop.",
